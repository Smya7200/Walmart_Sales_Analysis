...
--Results:
-- Cpi, fuel_price, temperature, and unemployment have low correlation scores.
...
GROUP BY month
ORDER BY month;
-- Avg. weekly sales are the highest during December.
...
GROUP BY quarter
ORDER BY quarter;
-- Quarter 4 has the highest average weekly sales.
...
GROUP BY year
ORDER BY year;
-- 2010 was scored the highest in average weekly sales.
...
ORDER BY year;
-- Total sales increase 6.96% from 2010 to 2011, however it decreases 18.30% from 2011 to 2012.
